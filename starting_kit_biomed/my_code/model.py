...
path.append ("../ingestion_program")  # Contains libraries you 
will need 
...
class model(BaseEstimator):
    ...
    def __init__(self):
        ...
        #pour avoir les scores de validation 
        #self.mymodel=GradientBoostingClassifierr()
        #self.mymodel=GaussianNB()
        #self.mymodel=RandomForestClassifie()
        #self.mymodel=KNeighborsClassifier()
        #self.mymodel=svm.SVC(probability=True)
